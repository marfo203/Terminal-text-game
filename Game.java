...
public class Game {
	...
	public void addLocation() { // Skapar våra Locations och lägger till dem i listan
		...
		locations.add(new Location("Home", "Du är hemma och mår bra blalalala", "Sydafrika", a, b, c, d));
	...
	public void addNeighbours() {
		locations.add(new Location("Home", "Du är hemma och mår bra blalalala", "Sydafrika", locations.get(1), locations.get(2), locations.get(3), null));
	...
	public void run() {
		...
		System.out.println("Your goal is to gain Stonks and influence. You can get a higher or lower value depending on the choises you make. \n"
				+ "You can see the value of your Stonks and Influence by typing \"Stonks\" or \"Influence\" at any time!");
